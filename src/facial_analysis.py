...
class FacialImageProcessing:
    ...
    def __init__(self, print_stat=False, minsize=32):
        ...
        with tf.Graph().as_default() as full_graph:
            for model_file in model_files:
                tf.import_graph_def(
                    FacialImageProcessing.load_graph_def(model_file), name=model_files[model_file]
                )
    ...
    def detect_faces(self, img):
        ...
        for j in range(len(scales)):
            ...
            boxes, _ = FacialImageProcessing.generateBoundingBox(
        ...
        if numbox > 0:
            ...
            dy, edy, dx, edx, y, ey, x, ex, tmpw, tmph = FacialImageProcessing.pad(
        ...
        if numbox > 0:
            ...
            if total_boxes.shape[0] > 0:
                ...
                total_boxes = total_boxes[pick, :]
                total_boxes = FacialImageProcessing.bbreg(
